...
import { SocialShareButtonsEN } from '@/components/SocialShareButtonsEN';
...
export async function generateMetadata({ params }: BlogPostPageProps): Promise<Metadata> {
  ...
  return {
    title: `${title} - Franciney Freitas Blog`,
    description,
    openGraph: {
      title,
      description,
    ...
    <section className="py-20 min-h-screen">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          {/* Back Button */}
          <div className="mb-8">
            <Link href="/eng/blog" prefetch={true}>
          ...
          <article>
            ...
            <SocialShareButtonsEN 
              postTitle={post.title.rendered.replace(/<[^>]*>/g, '')}
              postUrl={`${process.env.NEXT_PUBLIC_SITE_URL || 'https://francineyfreitas.dev'}/eng/blog/${post.slug}`}
            />
          </article>
            ...
            <div className="mt-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {relatedPosts.map((relatedPost) => {
                  ...
                  return (
                    <Link key={relatedPost.id} href={`/eng/blog/${relatedPost.slug}`} prefetch={true}>
                      <Card className="h-full overflow-hidden hover:shadow-xl transition-all duration-300 group cursor-pointer hover:-translate-y-1">
                        ...
                        <CardContent className="p-4">
                          ...
                          <p className="text-xs text-muted-foreground mt-2">
                            {formatPostDate(relatedPost.date, 'en-US')}
                          </p>
                        </CardContent>
                      </Card>
                    </Link>
